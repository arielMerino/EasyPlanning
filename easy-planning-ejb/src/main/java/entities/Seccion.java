...
@NamedQueries({
    ...
    @NamedQuery(name = "Seccion.findByAsignaturaAñoYSemestre",
            query = "SELECT s FROM Seccion s WHERE s.coordinacion.asignatura.id = :idAsg AND s.coordinacion.año = :año AND s.coordinacion.semestre = :semestre ")
})
